...
localStorage.setItem("shopamnt", parseInt(document.getElementById("hi").innerHTML));
var price = 100;
var price2 = 500;
var price3 = 1000;
...
function addGPU() {
    ...
    if (num < price) {
        ...
        gum = parseInt(document.getElementById("ngpu").innerHTML) + 1;
        document.getElementById("ngpu").innerHTML = gum;
        localStorage.setItem("shopamnt", parseInt(document.getElementById("hi").innerHTML));
        localStorage.setItem("gpuamnt", parseInt(document.getElementById("ngpu").innerHTML));
}
